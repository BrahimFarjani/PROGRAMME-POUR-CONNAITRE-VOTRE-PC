...
def banner():
    print(bcolors.AQUI + '''                                                                                   
          ...
          ''' + bcolors.END) 
    print("\033[44m Cet outil t'aidera à connaître ton PC!    ||    This tool will help you to know your PC!     ||      هذه الأداة ستساعدك على معرفة جهاز الكمبيوتر الخاص بك !\033[0m")
    ...
    print("5->Systéme type (64-bit/32-bit)")
...
match inp:
    ...
    case 2:
        ...
        try:
            ...
            print(f"Type de Disk non détecté: {e}")
    ...
    case 4:
        system_v = platform.version()
        print(f"# Version de système est: {system_v}")

    case 5:
         system_type = platform.architecture()[0]
         print(f"# Type de système: {system_type}")

    case 6:
        physical_cores = psutil.cpu_count(logical=False) 
        logical_cores = psutil.cpu_count(logical=True)
        print(f"# CPU cores physique: {physical_cores}")
        print(f"# CPU cores logique: {logical_cores}")
    ...
    case 10:
        ipconfig_result = subprocess.check_output("ifconfig", shell=True).decode("utf-8")
        print(f"# Les informations de configuration complètes (ifconfig): {ipconfig_result}")
